...
<html>
<head>
    <title>BikeRental - Edit User</title>
    ...
    <div class="max-w-lg mx-auto">
        <div class="bikerental-card p-8">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 mt-2">Update the user details</p>
            </div>
            ...
            <form action="editUser" method="post">
                ...
                <div class="form-group">
                    <input type="text" id="username" name="username" value="${user.username}" class="form-input" required placeholder=" " />
                ...
                <div class="form-group">
                    <input type="email" id="email" name="email" value="${user.email}" class="form-input" required placeholder=" " />
                ...
                <div class="form-group">
                    <input type="password" id="password" name="password" value="${user.password}" class="form-input" required placeholder=" " />
